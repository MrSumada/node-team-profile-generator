...
Prompts.prototype.addEmployee = function(employee) {
    ...
    },
    {
        ...
        inquirer.prompt(employeeQuestions).then(({name, ID, email, role}) => {
            console.log(name + ID + email);

            const newGuy = new Employee(name, ID, email, currentRole);
            console.log(newGuy);
        ...
        // .then(({ name, ID, email }) => {
        //     this.role = this.role;
            // const newGuy = new Employee(name, ID, email, role);
            // console.log(newGuy);
