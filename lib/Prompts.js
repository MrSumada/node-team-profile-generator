...
Prompts.prototype.addEmployee = function() {
    ...
    const employeeQuestions = [
        ...
        type: "input",
        name: "name",
        message: `What is the name of your ${currentRole}`,
        validate: nameInfo => {
            if (nameInfo) {
                return true;
            } else {
                console.log(`Please enter a name for your ${currentRole}?`);
                return false;
            }
        }
    },
    {
        type: "input",
        name: "ID",
        message: `What is the Employee ID of your ${currentRole}?`,
        validate: inputInfo => {
            if (inputInfo) {
                return true;
            } else {
                console.log(`Please enter an Employee ID for your ${currentRole}?`);
                return false;
            }
        }
    },
    {
        type: "input",
        name: "email",
        message: `What is the email of your ${currentRole}?`,
        validate: emailInfo => {
            if (emailInfo) {
                return true;
            } else {
                console.log(`Please enter an email for your ${currentRole}?`);
                return false;
            }
        }
    },
